...
//                View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.app_cconfirmedcarpool_layout_confirmed_ticket_entity, parent, false);
