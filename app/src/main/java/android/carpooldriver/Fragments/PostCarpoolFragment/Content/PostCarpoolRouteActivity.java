...
public class PostCarpoolRouteActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_post_carpool_route);

        // MODIFIES: this
        // EFFECTS: Generate map from Mapbox API.
        mapView = findViewById(R.id.post_new_carpool_one_map_view);
    ...
    private void initSearchOrigin() {
        RelativeLayout originRelativeLayout = (RelativeLayout) findViewById(R.id
                .origin_post_new_carpool_one);

        originRelativeLayout.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new PlaceAutocomplete.IntentBuilder()
                        .accessToken(getString(R.string.MAP_BOX_API_KEY))
    ...
    private void initSearchDestination() {
        RelativeLayout destinationRelativeLayout = (RelativeLayout) findViewById(R.id
                .destination_post_new_carpool_one);
