...
public class IndividualAcceptedDriverTicketActivity extends AppCompatActivity {

    public static final String TAG = IndividualAcceptedDriverTicketActivity.class.getSimpleName();
    private static final int MY_PERMISSIONS_REQUEST_CALL_PHONE = 1;
    private TelephonyManager mTelephonyManager;
    private MyPhoneCallListener mListener;
    private String receiverKeyID, currentUserUID, receiverUID;
    private RelativeLayout backButton;
    private DatabaseReference RiderRequestingDriverRef, RootRef, DriverTicketRef;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.layout_individual_accepted_driver_ticket);
        initializeFields();
        backButtonInit();
        gettingInformationFromFireBaseDatabase();
    ...
    private void initializeFields() {
        ...
        riderDate = findViewById(R.id.date_data_accepted_driver_ticket);
        riderTime = findViewById(R.id.time_data_accepted_driver_ticket);
        riderFrom = findViewById(R.id.origin_data_accepted_driver_ticket);
        riderName = findViewById(R.id.profile_name_accepted_drivers_ticket);
        riderTo = findViewById(R.id.destination_data_accepted_driver_ticket);
        riderPrice = findViewById(R.id.earnings_text_confirm_accepted_driver_ticket);
        riderNumberOfSeats = findViewById(R.id.passenger_seat_data_accepted_driver_ticket);
        RiderPhoneNumber = (TextView) findViewById(R.id.phone_number_data_accepted_driver_ticket);
        backButton = (RelativeLayout) findViewById(R.id.backButtonOniTicketaccepted);
    }
    ...
    private void gettingInformationFromFireBaseDatabase() {
        RiderRequestingDriverRef.child(currentUserUID).child(receiverKeyID).child("senderUID").addValueEventListener(new ValueEventListener() {
            @Override
        ...
        public void onCallStateChanged(int state, String incomingNumber) {
            ...
            switch (state) {
                case TelephonyManager.CALL_STATE_RINGING:
                    ...
                    Toast.makeText(IndividualAcceptedDriverTicketActivity.this, message, Toast.LENGTH_SHORT).show();
                    Log.i(TAG, message);
                    break;
                ...
                default:
                    ...
                    Toast.makeText(IndividualAcceptedDriverTicketActivity.this, message,
